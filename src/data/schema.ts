...
export const FIELD_SCHEMA: FieldDef[] = [
  ...
  { key: 'stockQty', label: 'Stock Qty', type: 'number', width: 110, defaultVisible: true, core: true, required: true, numeric: true, integer: true },
  { key: 'warehouse', label: 'Warehouse', type: 'enum', options: WAREHOUSES, width: 140, defaultVisible: true },
  { key: 'reorderPoint', label: 'Reorder Point', type: 'number', width: 130, defaultVisible: false, numeric: true, integer: true },
  ...
  { key: 'reviewCount', label: 'Review Count', type: 'number', width: 130, defaultVisible: false, numeric: true, integer: true },
  ...
  { key: 'minOrderQty', label: 'Min Order Qty', type: 'number', width: 130, defaultVisible: false, numeric: true, integer: true },
  { key: 'maxOrderQty', label: 'Max Order Qty', type: 'number', width: 130, defaultVisible: false, numeric: true, integer: true },
  { key: 'leadTimeDays', label: 'Lead Time (days)', type: 'number', width: 150, defaultVisible: false, numeric: true, integer: true },
  ...
  { key: 'shelfLifeDays', label: 'Shelf Life (days)', type: 'number', width: 150, defaultVisible: false, numeric: true, integer: true },
  ...
  { key: 'warrantyMonths', label: 'Warranty (mo)', type: 'number', width: 130, defaultVisible: false, numeric: true, integer: true },
  ...
  { key: 'version', label: 'Version', type: 'number', width: 90, defaultVisible: false, numeric: true, integer: true },
]
